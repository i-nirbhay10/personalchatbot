    ...
    <div className="fixed inset-0 bg-[#323232]">
      ...
      <div className="h-full max-w-4xl  mx-auto flex flex-col p-3">
        ...
        <div
          ...
          className="flex-1 overflow-auto w-full mb-4 rounded-lg bg-[#1F2123] shadow-lg md:p-4 hide-scrollbar"
        >
        ...
        >
          <div className="flex md:flex-1 sm:w-auto border border-gray-300 rounded p-2  focus:border-blue-400 focus:ring-1 focus:ring-blue-400 resize-none h-auto gap-2">
            ...
            <button
              type="submit"
              className={`flex items-center gap-3 px-2 md:px-6 py-2 bg-gradient-to-r from-[#1F2123] to-red-400 text-white rounded-md hover:bg-blue-600 transition-colors ${
